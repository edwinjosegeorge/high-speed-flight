\chapter{Methodology}
To perform agile flight through cluttered and previously-unseen environments, a sensorimotor policy is trained to predict receding-horizon \cite{receding_horizon}
trajectories from on-board sensor measurements and a reference trajectory. It is assumed that the reference trajectory is provided by a higher level planning algorithm \cite{global_planning} or the user. The reference is not necessarily
...
To decrease the dimension of the sampling space, a compact
